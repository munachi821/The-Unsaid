      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-7 items-center">
          ...
          <div className="flex space-x-4 text-base font-semibold">
            ...
            <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm transition-colors h-10 px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-full cursor-pointer">
              Signup
            </button>
          </div>
          <div
            className="size-10 flex items-center justify-center gap-2 border bg-background hover:bg-accent hover:text-accent-foreground h-10 w-10 rounded-full glassmorphism dark:glassmorphism-dark border-white/20 hover:scale-110 transition-all duration-300"
            onClick={toggleTheme}
          >
            {isDarkMode ? (
